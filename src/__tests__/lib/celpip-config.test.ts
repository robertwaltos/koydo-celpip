...
import { EXAM_CONFIG } from "@/lib/celpip/config";

describe("CELPIP Config", () => {
  it("has correct exam ID", () => { expect(EXAM_CONFIG.examId).toBe("EXAM017"); });
  ...
  it("has correct URL", () => { expect(EXAM_CONFIG.url).toBe("https://celpip.koydo.app"); });
