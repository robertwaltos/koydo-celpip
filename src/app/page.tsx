...
export const metadata: Metadata = {
  title: "Koydo CELPIP — Free Exam Prep",
  description: "Comprehensive CELPIP preparation. Practice tests, AI tutor, score tracking. This app is an independent study aid and is not affiliated with, endorsed by, or approved by CELPIP or any official testing authority. All trademarks belong to their respective owners.",
};
    ...
    <main className="min-h-screen">
      ...
      <section className="mx-auto max-w-5xl px-4 py-16">
        <h2 className="mb-10 text-center text-2xl font-bold text-zinc-900 dark:text-zinc-100">
          Why Koydo for CELPIP?
        </h2>
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {[
            { icon: "📝", title: "Practice Tests", desc: "Hundreds of practice questions matching the real CELPIP format." },
      ...
      <footer className="border-t border-zinc-200 dark:border-zinc-800 px-4 py-8">
        <p className="mx-auto max-w-3xl text-center text-xs text-zinc-500 dark:text-zinc-500">
          This app is an independent study aid and is not affiliated with, endorsed by, or approved by CELPIP or any official testing authority. All trademarks belong to their respective owners.
        </p>
