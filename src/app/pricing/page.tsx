...
export const metadata: Metadata = {
  title: "Pricing — Celpip Premium",
  description: "Unlock unlimited Celpip practice with Koydo Premium.",
};

export default function PricingPage() {
  const checkoutUrl = `https://koydo.app/pricing?exam=celpip&cadence=annual`;
