// Auto-generated shim — re-exports from @/lib/celpip/config
// This lets shared ecosystem components import from "@/lib/act/config"
import type { ExamConfig as _celpip_Config } from "@/lib/celpip/config";
import { EXAM_CONFIG as _raw } from "@/lib/celpip/config";
